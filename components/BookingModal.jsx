...
function BookingModal({ open, onClose }) {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      setError("Could not reach the desk. Please call +91 98765 00001.");
    } finally {
      setSending(false);
    }
  };
    ...
    <>
      ...
      <div className={"bm-shell " + (open ? "open" : "")} role="dialog" aria-label="Schedule a viewing">
        <header className="bm-head">
          <div>
            <div className="bm-eyebrow"><span className="bm-rule"/>Anand Promotors & Real Est. · Reservation Desk</div>
        ...
        {sent ? (
          ...
          <form className="bm-grid" onSubmit={submit}>
            ...
            <aside className="bm-col bm-col-summary">
              ...
              <Row k="Office"   v="Phase 7 · Mohali · Punjab · 160061" />
              ...
              <a href="tel:+919876500001" className="bm-call">Or call the desk · +91 98765 00001</a>
            </aside>
          </form>
        )}
      </div>
